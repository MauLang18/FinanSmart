// ignore_for_file: unnecessary_import, library_prefixes, library_private_types_in_public_api, sort_child_properties_last, use_super_parameters, non_constant_identifier_names

import 'package:finance_app/controllers/db_helper.dart';
import 'package:finance_app/pages/models/transaction.dart';
              ...
              children: [
                ...
                dataSet.isEmpty || dataSet.length < 2
                    ? Container(
                        ...
                        child: const Text(
                          "No hay datos suficientes para elaborar un gráfico",
                          style: TextStyle(
                            fontSize: 20.0,
                          ),
                        ),
